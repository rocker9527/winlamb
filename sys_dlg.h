...
/// @param filterWithPipes C# format filter: L"Text Files (*.txt)|*.txt|All Files (*.*)|*.*"
/// @see https://docs.microsoft.com/en-us/windows/win32/api/commdlg/nf-commdlg-getopenfilenamew
