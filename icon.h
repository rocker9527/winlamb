...
public:
	...
	/// On the resource editor, for the control, change "Type" property to "Icon".
	...
	/// @param iconSize Size of the icon to be loaded.
	...
	/// Converts the size enum to the corresponding SIZE (cx and cy).
