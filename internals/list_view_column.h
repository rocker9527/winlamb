...
public:
	...
	/// Inequality operator.
	[[nodiscard]] bool operator!=(const list_view_column& other) const noexcept { return !this->operator==(other); }

	/// Returns the HWND of the list view to which this column belongs.
