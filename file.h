...
public:
	...
	file_times times() const
	{
		...
		return {
			time::utc_to_local(time::filetime_to_time_point(creation)),
			time::utc_to_local(time::filetime_to_time_point(lastAccess)),
			time::utc_to_local(time::filetime_to_time_point(lastWrite))
		};
	}
